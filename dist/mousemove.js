...
var project_titles = document.querySelectorAll(
  ".movable-gallery-project-title"
);
var movable_gallery_item = document.querySelectorAll(".movable-gallery-item");
var movable_gallery_item_image = document.querySelectorAll(
  ".movable-gallery-image"
);
var movable_gallery_project_detail = document.querySelectorAll(
  ".movable-gallery-project-detail"
);
var movable_gallery_number = document.querySelectorAll(
  ".movable-gallery-number"
);
...
if (!isMobile()) {
  ...
  var convert_range = current_position => {
    return (
      ((current_position - -offset_distance) /
  ...
  document.addEventListener("click", () => {
    if (
      current_cursor_value === "right" &&
      number_of_clicks < movable_gallery_item.length - 2 &&
      animation_flag === true
    ) {
      ...
      gallery_item_move_timeline
        .to(movable_gallery_item, 2, {
          x:
            "-=" + (movable_gallery_item[0].getBoundingClientRect().width + 80),
          ease: "power4.inOut"
        })
        .to(
          movable_gallery_item_image,
          1,
          { scaleX: 1.1, ease: "power4.in" },
          0
        )
        .to(
          movable_gallery_item_image,
...
/** touch scripts */
>>>>>>> 7946b2e64ce03977d4d54e8090bd7cd17342a429
